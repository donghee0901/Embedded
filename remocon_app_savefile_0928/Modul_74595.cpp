...
unsigned unsigned char count_74595 = 0;
unsigned unsigned char duty_74595 = 1;

void pwm_74595(unsigned long c_millis, unsigned long c_micros, unsigned char pwm_pin, unsigned unsigned char cycle_74595)
{
...
void lcd_inst_4bit_high_74595(unsigned unsigned char inst_high) {
  //RS LOW
  data_74595 &= ~0x01;
  set_data_74595(data_74595);
...
void lcd_inst_4bit_low_74595(unsigned unsigned char inst_low) {
  //RS LOW
  data_74595 &= ~0x01;
  set_data_74595(data_74595);
...
void lcd_data_4bit_high_74595(unsigned unsigned char data_high) {
  data_74595 &= ~0xF0;
...
void lcd_data_4bit_low_74595(unsigned unsigned char data_low) {
  data_74595 &= ~0xF0;
...
//---------------------------------------------------------------------------------
  ...
  void lcd_inst_8bit_74595(unsigned unsigned char           inst) {
